<template>
  ...
  <div class="text" style="opacity: 1; box-shadow: rgba(0, 0, 0, 0.09) 0px 2px 1px, rgba(0, 0, 0, 0.09) 0px 4px 2px, rgba(0, 0, 0, 0.09) 0px 8px 4px, rgba(0, 0, 0, 0.09) 0px 16px 8px, rgba(0, 0, 0, 0.09) 0px 32px 16px;">
    <h2 class="nom">Votre réservation a bien été éffectuée.<br/> Un email de confirmation vous a été envoyé.
    </h2>
    <h3> (Vérifiez vos spam si vous n'avez pas reçu la confirmation) </h3>
    <h3 class="description">En vous remerciant.</h3>
    <p class="info"></p>
  </div></div>
